...
export default function Main() {
    return (
        <div className="h-screen w-full bg-gradient-to-r from-blue-900 to-blue-950 relative flex">
            ...
            <div className="h-full w-2/6 bg-gray-200 absolute right-0 flex flex-col gap-10 p-10">
                ...
                <Link className='mx-auto' to={'/dashboard'}>
                    <button className='bg-blue-400 w-auto h-auto px-5 py-2 rounded font-open-sans transition hover:bg-blue-600 hover:text-white'>Ingresar al programa</button>
                </Link>
            </div>
        </div>
    )
