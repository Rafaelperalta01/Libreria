...
const Libro = (libro) => {
  ...
  const NavegarADetalles = () => {
    navigate(`/dashboard/VerDetalles/:${libro.id}`, { state: libro }) //declaro la direccion y paso el objeto de datos
  }
  ...
  return (
    ...
    >
      <div className="h-38 p-4">
        <h3 className="text-base text-center font-semibold mb-2">{libro.titulo}</h3>
